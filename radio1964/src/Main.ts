...
class Main extends egret.DisplayObjectContainer {
    ...
    private bgmBtn:egret.Bitmap;
    private soundChannel:egret.SoundChannel;
    private bgmTW:egret.Tween;

    private bgmPlay():void{
        console.log("bgmPlay");
    ...
    private createGameScene() {
        ...
        let tree = this.createBitmapByName("christmas_tree_png");
        this.addChild(tree);
        let targetH = stageH * 0.72;
        let targetW = (targetH/tree.height)*tree.width;
        tree.height = targetH;
        tree.width = targetW;
        ...
        let giftbox = new GiftBox(stageW,stageH,tree.x,tree.y + tree.height);
        ...
        let popBox = new PopBox(stageW,stageH);
